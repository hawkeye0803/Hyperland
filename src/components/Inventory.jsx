          ...
          {NFTData.map(({ texture, src, isOpen }) => {
            return (
              <div
                ...
                style={{ backgroundColor: isOpen ? "#ffffff" : "#87878776" }}
                className={`w-[120px] h-[140px] rounded-xl flex flex-col gap-1  justify-end p-2 pt-2 items-center shadow-xl border-2 border-[#323232] hover:scale-[101%]`}
              >
                <h3 className=" w-full ml-3 text-xs">Item</h3>
                <div className="w-[105px]  h-[150px] make-flex justify-end flex-col border-2 border-[#8b8b8b] rounded-xl">
